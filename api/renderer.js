...
/*!*********************************!*\
  ...
  \*********************************/
/*! exports provided: default */function(e,t,n){"use strict";n.r(t);var r=n(/*! preact */"preact");class s extends r.Component{constructor(...e){var t,n,r;super(...e),t=this,n="state",r={time:Date.now()},n in t?Object.defineProperty(t,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[n]=r}componentDidMount(){this.timer=setInterval(()=>{this.setState({time:Date.now()})},1e3)}componentWillUnmount(){clearInterval(this.timer)}render(){let e=new Date(this.state.time).toLocaleTimeString();return Object(r.h)("h1",{class:"x-secondary cx"},e)}}t.default=s},"./src/components/QueryTester.js":
/*!***************************************!*\
  !*** ./src/components/QueryTester.js ***!
  \***************************************/
/*! exports provided: default */function(e,t,n){"use strict";n.r(t);var r=n(/*! preact */"preact"),s=n(/*! @apollo/react-hooks */"@apollo/react-hooks"),o=n(/*! react-helmet */"react-helmet"),a=n(/*! graphql-tag */"graphql-tag"),i=n.n(a);t.default=({props:e})=>{const{loading:t,error:n,data:{i:a}={}}=Object(s.useQuery)(i()("query {\n  i {\n    makes {\n      id\n      name\n      car\n      motorcycle\n      slug\n      seotext\n    }\n    services {\n      id\n      name\n      car\n      motorcycle\n      slug\n      seotext\n      icon\n      carbutton\n      motobutton\n      invisible\n    }\n  }\n}\n"));return t?Object(r.h)("p",null,"Loading ..."):Object(r.h)(r.Fragment,null,Object(r.h)(o.Helmet,null,Object(r.h)("title",null,"Preact SSR Example with GraphQl"),Object(r.h)("link",{rel:"canonical",href:"http://mysite.com/example"})),a.services.map((e,t)=>Object(r.h)("p",{key:t},Object(r.h)("strong",null,e.name," "),e.seotext)))}},"./src/config/patchPreactSSR.js":
/*!**************************************!*\
...
/*!*************************************!*\
  ...
  \*************************************/
/*! exports provided: getClient */function(e,t,n){"use strict";n.r(t),n.d(t,"getClient",(function(){return u}));var r=n(/*! apollo-client */"apollo-client"),s=n(/*! apollo-link */"apollo-link"),o=n(/*! apollo-link-http */"apollo-link-http"),a=n(/*! apollo-link-retry */"apollo-link-retry"),i=n(/*! apollo-cache-inmemory */"apollo-cache-inmemory"),c=n(/*! node-fetch */"node-fetch"),l=n.n(c);function u(e){const t=function(e){const t=Object(o.createHttpLink)({uri:e,fetch:l.a}),n=new a.RetryLink({delay:{initial:1e4,max:2e3,jitter:!0},attempts:{max:2,retryIf:(e,t)=>!!e}});return s.ApolloLink.from([n,t])}(e);return new r.ApolloClient({link:t,cache:new i.InMemoryCache,ssrForceFetchDelay:900,ssrMode:!0})}},"./src/renderer.js":
/*!*************************!*\
  !*** ./src/renderer.js ***!
  \*************************/
/*! exports provided: default */function(e,t,n){"use strict";n.r(t);n(/*! ./config/patchPreactSSR */"./src/config/patchPreactSSR.js");var r=n(/*! preact */"preact"),s=n(/*! @apollo/react-hooks */"@apollo/react-hooks"),o=n(/*! @loadable/server */"@loadable/server"),a=n(/*! react-router-dom */"react-router-dom"),i=n(/*! react-helmet */"react-helmet"),c=n(/*! ./graphql/getClientSSR */"./src/graphql/getClientSSR.js"),l=n(/*! @apollo/react-ssr */"@apollo/react-ssr"),u=n(/*! ./site/App.js */"./src/site/App.js"),p=n(/*! preact-render-to-string */"preact-render-to-string"),d=n.n(p),m=n(/*! ../public/loadable-stats.json */"./public/loadable-stats.json");const h=Object(c.getClient)(process&&process.env&&process.env.GRAPHQL_ENDPOINT||"https://s.meccamico.com/graphql"),f={};t.default=async(e,t)=>{const n=new o.ChunkExtractor({stats:m}),c=Object(r.h)(s.ApolloProvider,{client:h},Object(r.h)(a.StaticRouter,{location:e.url,context:f},Object(r.h)(u.default,null))),p=await function(e){return Object(l.getMarkupFromTree)({tree:e,renderFunction:d.a})}(n.collectChunks(c));console.log(e.method," ",e.baseUrl||e.url);const b=n.getScriptTags(),g=n.getLinkTags(),j=n.getStyleTags(),k=i.Helmet.renderStatic();return t.send('<!DOCTYPE html>\n<html lang="it">\n  <head>\n    <title></title>\n\t\t<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">\n\t\t<link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">\n\t\t<link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">\n\t\t<link rel="manifest" href="/manifest.json">\n\t\t<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#060930">\n\t\t<meta name="robots" content="index, follow">\n\t\t<meta name="viewport" content="width=device-width, initial-scale=1.0">\n\t\t<meta name="msapplication-TileColor" content="#060930">\n\t\t<meta name="theme-color" content="#ffffff">\n    <meta name=\'twitter:site\' content="@meccamico" />\n    <meta name=\'twitter:creator\' content="@meccamico" />\n    <meta property=\'og:site_name\' content="Meccamico" />\n  </head>\n  <body>\n\t\t<div id="main"></div>\n  </body>\n</html>\n\n\n'.replace('<div id="main"></div>',`<div id="main">${p}</div>`).replace("</body>",b+`<script>window.__APOLLO_STATE__ = ${JSON.stringify(h.extract())}<\/script>`+"</body>").replace("<title></title>",k.title.toString()+k.meta.toString()+g+j).replace(/(\r\n|\n|\r)/gm,"").replace(/\s\s+/g,""))}},"./src/site/App.js":
/*!*************************!*\
  !*** ./src/site/App.js ***!
  \*************************/
...
/*!****************************!*\
  !*** ./src/utils/index.js ***!
  \****************************/
/*! exports provided: loadable */function(e,t,n){"use strict";n.r(t);var r=n(/*! ./loadable */"./src/utils/loadable.js");n.d(t,"loadable",(function(){return r.default}))},"./src/utils/loadable.js":
/*!*******************************!*\
  !*** ./src/utils/loadable.js ***!
  \*******************************/
/*! exports provided: default */function(e,t,n){"use strict";n.r(t),n.d(t,"default",(function(){return i}));var r=n(/*! preact */"preact"),s=n(/*! @loadable/component */"@loadable/component"),o=n.n(s),a=n(/*! ../site/Loading */"./src/site/Loading.js");function i(e){return o()(e,{fallback:Object(r.h)(a.default,null)})}},0:
/*!*******************************!*\
