...
/*!***************************************!*\
  ...
  \***************************************/
/*! exports provided: default */function(e,t,s){"use strict";s.r(t);var n=s(/*! preact */"preact"),r=s(/*! @apollo/react-hooks */"@apollo/react-hooks"),i=s(/*! react-helmet */"react-helmet"),a=s(/*! graphql-tag */"graphql-tag"),c=s.n(a);t.default=({props:e})=>{const{loading:t,error:s,data:{i:a}={}}=Object(r.useQuery)(c()("query {\n  i {\n    makes {\n      id\n      name\n      car\n      motorcycle\n      slug\n      seotext\n    }\n    services {\n      id\n      name\n      car\n      motorcycle\n      slug\n      seotext\n      icon\n      carbutton\n      motobutton\n      invisible\n    }\n  }\n}\n"));return t?Object(n.h)("p",null,"Loading ..."):Object(n.h)(n.Fragment,null,Object(n.h)(i.Helmet,null,Object(n.h)("title",null,"Preact SSR Example with GraphQl"),Object(n.h)("link",{rel:"canonical",href:"http://mysite.com/example"})),a.services.map((e,t)=>Object(n.h)("p",{key:t},Object(n.h)("strong",null,e.name," "),e.seotext)))}},"./src/config/patchPreactSSR.js":
/*!**************************************!*\
...
/*!*************************************!*\
  ...
  \*************************************/
/*! exports provided: getClient */function(e,t,s){"use strict";s.r(t),s.d(t,"getClient",(function(){return u}));var n=s(/*! apollo-client */"apollo-client"),r=s(/*! apollo-link */"apollo-link"),i=s(/*! apollo-link-http */"apollo-link-http"),a=s(/*! apollo-link-retry */"apollo-link-retry"),c=s(/*! apollo-cache-inmemory */"apollo-cache-inmemory"),o=s(/*! node-fetch */"node-fetch"),l=s.n(o);function u(e){const t=function(e){const t=Object(i.createHttpLink)({uri:e,fetch:l.a}),s=new a.RetryLink({delay:{initial:1e4,max:2e3,jitter:!0},attempts:{max:2,retryIf:(e,t)=>!!e}});return r.ApolloLink.from([s,t])}(e);return new n.ApolloClient({link:t,cache:new c.InMemoryCache,ssrForceFetchDelay:900,ssrMode:!0})}},"./src/renderer.js":
/*!*************************!*\
  !*** ./src/renderer.js ***!
  \*************************/
/*! exports provided: default */function(e,t,s){"use strict";s.r(t);s(/*! ./config/patchPreactSSR */"./src/config/patchPreactSSR.js");var n=s(/*! preact */"preact"),r=s(/*! @apollo/react-hooks */"@apollo/react-hooks"),i=s(/*! @loadable/server */"@loadable/server"),a=s(/*! react-router-dom */"react-router-dom"),c=s(/*! react-helmet */"react-helmet"),o=s(/*! ./graphql/getClientSSR */"./src/graphql/getClientSSR.js"),l=s(/*! @apollo/react-ssr */"@apollo/react-ssr"),u=s(/*! ./site/App.js */"./src/site/App.js"),d=s(/*! preact-render-to-string */"preact-render-to-string"),m=s.n(d),p=s(/*! ../public/loadable-stats.json */"./public/loadable-stats.json");const h=Object(o.getClient)(process&&process.env&&process.env.GRAPHQL_ENDPOINT||"https://s.meccamico.com/graphql"),f={};t.default=async(e,t)=>{const s=new i.ChunkExtractor({stats:p}),o=Object(n.h)(r.ApolloProvider,{client:h},Object(n.h)(a.StaticRouter,{location:e.url,context:f},Object(n.h)(u.default,null))),d=await(b=s.collectChunks(o),Object(l.getMarkupFromTree)({tree:b,renderFunction:m.a}));var b;console.log(e.method," ",e.baseUrl||e.url);const k=s.getScriptTags(),j=s.getLinkTags(),g=s.getStyleTags(),v=c.Helmet.renderStatic();return t.send('<!DOCTYPE html>\n<html lang="it">\n  <head>\n    <title></title>\n\t\t<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">\n\t\t<link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">\n\t\t<link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">\n\t\t<link rel="manifest" href="/manifest.json">\n\t\t<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#060930">\n\t\t<meta name="robots" content="index, follow">\n\t\t<meta name="viewport" content="width=device-width, initial-scale=1.0">\n\t\t<meta name="msapplication-TileColor" content="#060930">\n\t\t<meta name="theme-color" content="#ffffff">\n    <meta name=\'twitter:site\' content="@meccamico" />\n    <meta name=\'twitter:creator\' content="@meccamico" />\n    <meta property=\'og:site_name\' content="Meccamico" />\n  </head>\n  <body>\n\t\t<div id="main"></div>\n  </body>\n</html>\n\n\n'.replace('<div id="main"></div>',`<div id="main">${d}</div>`).replace("</body>",k+`<script>window.__APOLLO_STATE__ = ${JSON.stringify(h.extract())}<\/script>`+"</body>").replace("<title></title>",v.title.toString()+v.meta.toString()+j+g).replace(/(\r\n|\n|\r)/gm,"").replace(/\s\s+/g,""))}},"./src/site/App.js":
/*!*************************!*\
  !*** ./src/site/App.js ***!
  \*************************/
